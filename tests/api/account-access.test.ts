...
beforeAll(async () => {
  ...
  admin = openDatabaseStore(process.env.TEST_DATABASE_ADMIN_URL);
  await runDatabaseMigrations(admin, { runtimePassword: process.env.TEST_DATABASE_RUNTIME_PASSWORD });
